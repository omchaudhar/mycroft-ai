...
| [Video brief](docs/VIDEO_BRIEF.md) | Setup and click-by-click recording instructions, for someone with no context |
| [Full demo script](docs/DEMO_FULL_SCRIPT.md) | The narration word for word, timed to the prototype |
